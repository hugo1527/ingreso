...
/**
 *	Class to manage PDF template standard_vehiculo_datos
 */
class pdf_standard_vehiculo_datos extends ModelePDFVehiculo_Datos
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Vehiculo_Datos	$object     	Object to show
