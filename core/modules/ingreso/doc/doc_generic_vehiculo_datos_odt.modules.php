...
/**
 *	\file       htdocs/core/modules/ingreso/doc/doc_generic_vehiculo_datos_odt.modules.php
 *	\ingroup    ingreso
 *	\brief      File of class to build ODT documents for vehiculo_datoss
 */

dol_include_once('/ingreso/core/modules/ingreso/modules_vehiculo_datos.php');
 ...
 */
class doc_generic_vehiculo_datos_odt extends ModelePDFVehiculo_Datos
{
	/**
	 * Issuer
	 * @var Societe
	...
	public function info($langs)
	{
		...
		if ($nbofiles) {
			...
			foreach ($listoffiles as $file) {
				$texte .= '- '.$file['name'].' <a href="'.DOL_URL_ROOT.'/document.php?modulepart=doctemplates&file=ingreso_vehiculo_datos/'.urlencode(basename($file['name'])).'">'.img_picto('', 'listlight').'</a>';
	 ...
	 *
	 *  @param	Vehiculo_Datos	$object				Source object to generate document from
