...
/**
 *  \file       core/modules/ingreso/doc/pdf_standard.modules.php
 *  \ingroup    ingreso
...
/**
 *	Class to manage PDF template standard_personales_datos
 */
class pdf_standard_personales_datos extends ModelePDFPersonales_Datos
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	Personales_Datos	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('INGRESO_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('INGRESO_DRAFT_WATERMARK')));
		}
