...
/**
 *       \file       htdocs/ingreso/ajax/datos.php
 *       \brief      File to return Ajax response on datos list request
 */
...
// Security check
if (!$user->hasRight('ingreso', 'datos', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax ingreso/ajax/datos.php");
