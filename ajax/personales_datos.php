...
/**
 *       \file       htdocs/ingreso/ajax/personales_datos.php
 *       \brief      File to return Ajax response on personales_datos list request
 */
...
// Security check
if (!$user->hasRight('ingreso', 'personales_datos', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax ingreso/ajax/personales_datos.php");
