...
/**
 *       \file       htdocs/ingreso/ajax/vehiculo_datos.php
 *       \brief      File to return Ajax response on vehiculo_datos list request
 */
...
// Security check
if (!$user->hasRight('ingreso', 'vehiculo_datos', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax ingreso/ajax/vehiculo_datos.php");
