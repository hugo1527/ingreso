...
/**
 *   	\file       personales_datos_list.php
 *		\ingroup    ingreso
 *		\brief      List page for personales_datos
 */
...
require_once __DIR__.'/class/personales_datos.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('ingreso', 'personales_datos', 'write');
	$permissiontodelete = $user->hasRight('ingreso', 'personales_datos', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Personales_Datos';
	$objectlabel = 'Personales_Datos';
...
$title = $langs->trans("Personales_Datoss");
//$help_url = "EN:Module_Personales_Datos|FR:Module_Personales_Datos_FR|ES:Módulo_Personales_Datos";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/ingreso/personales_datos_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/ingreso/personales_datos_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendPersonales_DatosRef";
$modelmail = "personales_datos";
$objecttmp = new Personales_Datos($db);
